...
class TestRenderingVerifier(TempDirFixture, LogTestCase, PEP8MixIn):
    ...
    def test_get_part_size(self):
        ...
        rv = RenderingVerifier(lambda: None, verification_data)
    ...
    def test_simple_verification(self):
        ...
        rv.simple_verification(verification_data)
...
class TestFrameRenderingVerifier(TempDirFixture):
    def test_simple_verification_frames(self):
        ...
        frv = FrameRenderingVerifier(callback, verification_data)

        frv.subtask_info = subtask_info
        frv.simple_verification(verification_data)
    ...
    def test_get_part_img_size(self):
        ...
        frv = FrameRenderingVerifier(lambda: None, verification_data)
        subtask_info = {
            "res_x": 600,
            "res_y": 800,
            "total_tasks": 20,
