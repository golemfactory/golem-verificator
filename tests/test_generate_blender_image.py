...
from golem_verificator.blender.gen_file import generate_blenderimage, \
...
class TestGenerateBlenderImage(TestCase):
    def setUp(self):
        ...
        self.scene_dir = os.path.join("files_for_tests","blender")
    ...
    def test_generate_blender_image(self):
        ...
        rendered_img = cv2.imread(self.real_out_file1)
    ...
    def test_generate_blender_image_with_params(self):
        ...
        rendered_img = cv2.imread(self.real_out_file3)
        size = rendered_img.shape[:2]
        assert size == (100,250)
