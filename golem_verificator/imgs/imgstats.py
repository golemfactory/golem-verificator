...
class ImgStatistics(object):
    ...
    @staticmethod
    def _calculate_color_normalized_mse(img1, img2):
        mse = 0
        (res_x, res_y) = img1.get_size()
...
class ImgVerificator(object):
    ...
    @staticmethod
    def get_random_crop_window(coverage=0.2, window=(0, 1, 0, 1)):
        """
        :param coverage:
    ...
    @staticmethod
    def is_valid_against_reference(img_stat, reference_img_stat,
        ...
        if not isinstance(img_stat, ImgStatistics) \
            ...
            raise TypeError("img_statistics be instance of ImgStatistics")
